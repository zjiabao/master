...
public:
    ...
    void setupUi(QWidget *DYELogAnalyzeToolDlg)
    {
        ...
        LISTWIDGET_SHOWANALYZERESULT->viewport()->setProperty("cursor", QVariant(QCursor(Qt::IBeamCursor)));
        ...
        LISTWIDGET_SHOWTXTCONTEXT->viewport()->setProperty("cursor", QVariant(QCursor(Qt::IBeamCursor)));
        pushButton = new QPushButton(DYELogAnalyzeToolDlg);
    ...
    void retranslateUi(QWidget *DYELogAnalyzeToolDlg)
    {
        ...
        pushButton->setText(QApplication::translate("DYELogAnalyzeToolDlg", "PushButton", Q_NULLPTR));
    } // retranslateUi
